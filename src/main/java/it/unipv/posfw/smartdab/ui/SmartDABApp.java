...
import it.unipv.posfw.smartdab.ui.controller.DispositivoController;
...
public class SmartDABApp {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            DispositiviManager dispositiviManager = new DispositiviManager();
            ...
            // 4. Crea Controller per dispositivi
            new DispositivoController(frame.getMainPanel(), gestoreStanze, dispositiviManager);
