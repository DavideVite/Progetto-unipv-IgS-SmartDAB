...
public class StanzeFormPanel extends JPanel{
	...
	public StanzeFormPanel(StanzeController controller) {
		...
		btnSalva.addActionListener(e -> { if (this.controller != null) this.controller.salvaStanza(); });
		btnElimina.addActionListener(e -> { if (this.controller != null) this.controller.eliminaStanza(); });
		btnAnnulla.addActionListener(e -> { if (this.controller != null) this.controller.annullaStanza(); });
