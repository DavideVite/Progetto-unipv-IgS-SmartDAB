...
public class StanzaTest {
	...
	void addDispositivo_addDeviceToList() {
		Lampada_ON_OFF lampada = new Lampada_ON_OFF(null, communicator, null , 3000 );
	...
	void removeDispositivo_removesFromList() {
		Lampada_ON_OFF lampada = new Lampada_ON_OFF(null, communicator, null , 800 );
        stanza.addDispositivo(lampada);
    ...
    void isEmpty_returnsTrueWhenNoDevices() {
        ...
        Lampada_ON_OFF lampada = new Lampada_ON_OFF(null, communicator, null , 2000 );
        stanza.addDispositivo(lampada);
        assertFalse(stanza.isEmpty());
    }
